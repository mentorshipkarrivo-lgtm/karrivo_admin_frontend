...
//         style={{ textAlign: "center", color: "#eb660f" }}
//       >
//         User Details
//       </h2>
//       <div className="user-details">
...
//           <div className="col-md-6 mb-3">{renderPhoneField()}</div>
...
//           <div className="col-md-6 mb-3">
//             <div className="form__box">
//               <label htmlFor="">Account Created On</label>
//               <input
//                 type="text"
//                 autoComplete="off"
//                 className="form-control shadow-none"
...
import React, { useState, useEffect } from "react";
import { useUpdateUserInfoMutation, useGetUserInfoQuery } from "./userinfoApiSlice";
import { toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
  ...
  const handleSaveField = async (fieldName) => {
    ...
    //   console.log("Update response:", response);
      ...
      if (response && response.success) {
        ...
        // Ensure we have the correct username in the search term
        if (setSearchTerm && searchTerm !== user.username) {
          setSearchTerm(user.username);
        }
        
        // Manually refetch the user data
        if (refetchUserInfo && typeof refetchUserInfo === 'function') {
          refetchUserInfo();
        }
