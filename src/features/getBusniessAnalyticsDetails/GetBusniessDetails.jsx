...
function GetBusinessDetails() {
  ...
  const [currentView, setCurrentView] = useState("details"); // "analytics" or "details"
  ...
  const getAnalyticsData = () => {
    ...
    // Monthly data based on transactions - FIXED TO INCLUDE YEAR
    const monthlyStats = {};
    usersData.forEach((user) => {
      // Process orders
      if (user.orders && user.orders.length > 0) {
        user.orders.forEach((order) => {
          const date = new Date(order.createdAt);
          // Changed to include year: "Jan 2024" format
          const monthKey = date.toLocaleString("default", {
            month: "short",
            year: "numeric",
          });
          const sortKey = date.getFullYear() * 100 + date.getMonth(); // For proper sorting
    ...
    // Sort monthly data chronologically and convert users Set to size
  ...
  // Analytics Dashboard Component - ENHANCED RESPONSIVE DESIGN
  const AnalyticsDashboard = () => {
    const analytics = getAnalyticsData();
    ...
    return (
      ...
      >
        ...
        <div className="mb-4">
          <h2
            className="text-white mb-2 fs-4 fs-md-3 fs-lg-2"
            style={{ fontWeight: "bold" }}
          >
            📊 Business Analytics Dashboard
          </h2>
          <p className="small text-muted mb-0" style={{ color: "#94a3b8" }}>
            Monitor your business performance in real-time • Date Range:{" "}
            {formatDate(formValues.fromDate)} to {formatDate(formValues.toDate)}
          </p>
        </div>

        {/* Top Metrics Cards - Enhanced Responsive */}
        <div className="row g-3 g-md-4 mb-4 mb-md-5">
          ...
          <div className="col-6 col-lg-3">
            ...
            >
              ...
              <div
                className="fs-4 fs-md-3 fs-lg-2 fw-bold mb-1"
                style={{ lineHeight: "1.2" }}
              >
                {analytics.totalUsers.toLocaleString()}
              </div>
              <div className="small" style={{ opacity: 0.8, fontSize: "12px" }}>
                Total Users
              </div>
            </div>
          </div>
              ...
              <div className="d-flex align-items-center justify-content-between mb-2 mb-md-3">
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 5a1 1 0 000 2h1a2 2 0 001.732 1H11a1 1 0 100-2H9.732A2 2 0 007 5z"
                    />
                  </svg>
                  <svg
                    width="24"
        ...
        {/* Charts Grid - Enhanced Responsive */}
        <div className="row g-3 g-md-4 mb-4 mb-md-5">
          {/* Monthly Trend Chart */}
          <div className="col-12 col-xl-8 mb-3 mb-xl-0">
            ...
            >
              <div className="d-flex align-items-center justify-content-between mb-3 mb-md-4 flex-wrap">
                <h5
                  className="text-white fs-6 fs-md-5 mb-2 mb-md-0"
                  style={{ margin: 0 }}
                >
              ...
              <div style={{ height: "250px" }} className="d-none d-md-block">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={analytics.monthlyData}>
                    <defs>
                      <linearGradient
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={analytics.monthlyData}>
                    ...
                    <CartesianGrid
                      ...
                      stroke="rgba(255,255,255,0.1)"
                    />
                    <XAxis dataKey="month" stroke="#E5E7EB" fontSize={10} />
                    ...
                    <Area
                      ...
                      stroke="#06B6D4"
                      strokeWidth={2}
                      fill="url(#investmentGradientMobile)"
                    />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
          ...
          <div className="col-12 col-xl-4">
            <div
              ...
              className="p-3 p-md-4"
            >
              <h5 className="text-white fs-6 fs-md-5 mb-3 mb-md-4">
                Payment Methods
              </h5>
              {analytics.paymentModeData.length > 0 ? (
                <>
                  ...
                  <div className="mt-3">
                    {analytics.paymentModeData.map((item, index) => (
                      ...
                      >
                        ...
                        <span
                          className="small text-white fw-semibold"
                          style={{ fontSize: "12px" }}
                        >
                          ₹{item.value.toLocaleString()}
                        </span>
                ...
                <div
                  ...
                  style={{ color: "#94a3b8", padding: "30px 0" }}
                >
                  <svg
                    width="36"
                    height="36"
                  ...
                  <p className="small mb-0">No payment data available</p>
                </div>
              )}
            </div>
          </div>
        ...
        {/* Bottom Row - Enhanced Responsive (Monthly Users Bar Chart Only) */}
        <div className="row g-3 g-md-4">
          ...
          <div className="col-12">
            ...
            >
              ...
              <div style={{ height: "220px" }} className="d-none d-md-block">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={analytics.monthlyData}>
                    <CartesianGrid
                      strokeDasharray="3 3"
              ...
              {/* Mobile Bar Chart */}
              <div style={{ height: "180px" }} className="d-block d-md-none">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={analytics.monthlyData}>
                    <CartesianGrid
                      strokeDasharray="3 3"
        ...
        {/* Footer Stats */}
        <div
          className="mt-4 mt-md-5 pt-3 pt-md-4"
        ...
        >
          <div className="row g-3 text-center">
            <div className="col-6 col-md-3">
              ...
              <div
                className="fw-semibold text-white small"
                style={{ fontSize: "12px" }}
              >
                {analytics.monthlyData.length > 0
                  ? `${analytics.monthlyData[0]?.month} - ${
              ...
              >
                {analytics.monthlyData.length > 0
                  ? analytics.monthlyData.reduce(
                      (max, month) =>
                        month.investments > max.investments ? month : max,
                  ...
                  <div className="btn-group" role="group">
                    <button
                      ...
                      style={{
                        ...
                        borderColor: "#ec660f",
                        color:
                          currentView === "analytics" ? "white" : "#ec660f",
                        fontWeight: "600",
                        padding: "10px 20px",
                        transition: "all 0.3s ease",
                      }}
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor:
                          currentView === "details" ? "#ec660f" : "transparent",
                        borderColor: "#ec660f",
                          ...
                          <div className="card-body">
                            ...
                            {Object.keys(totalStats.paymentModeStats).length >
                              ...
                              <>
                                ...
                                <div className="row text-center">
                                  {Object.entries(
                                    totalStats.paymentModeStats
                                  ).map(([mode, stats], index) => (
                                    <div
                                      key={mode}
                                      className="col-md-4 col-sm-6 mb-3"
                                    >
