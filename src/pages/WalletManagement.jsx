                    ...
                    <div className="col-12">
                      <div className="row g-3">
                        ...
                        <div className="col-6 col-sm-3">
                          <div className="card border-0 bg-warning bg-opacity-25 shadow rounded-3">
                              ...
                              <div className="d-flex align-items-center justify-content-center">
                                ...
                                <div>
                                  <h5 className="mb-0 fw-bold text-white">
                                    {tableData.data.statusCounts.Pending}
                                  </h5>
                        ...
                        {/* Completed */}
                        <div className="col-6 col-sm-3">
                          <div className="card border-0 bg-success bg-opacity-25 shadow rounded-3">
                            <div className="card-body text-center py-3 text-white">
                              <div className="d-flex align-items-center justify-content-center">
                                <Icon
                        ...
                        {/* Hold */}
                        <div className="col-6 col-sm-3">
                          <div className="card border-0 bg-info bg-opacity-25 shadow rounded-3">
                            <div className="card-body text-center py-3 text-white">
                              <div className="d-flex align-items-center justify-content-center">
                                <Icon
                                ...
                                <div>
                                  <h5 className="mb-0 fw-bold text-white">
                                    {tableData.data.statusCounts.Hold}
                                  </h5>
                                  <small className="text-white">Hold</small>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        {/* Failed */}
                        <div className="col-6 col-sm-3">
                          <div className="card border-0 bg-danger bg-opacity-25 shadow rounded-3">
                            <div className="card-body text-center py-3 text-white">
                              <div className="d-flex align-items-center justify-content-center">
                                <Icon
